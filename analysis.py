...
# output: object (class written by Ole and Lukas) with attributes describing the ascend and descend of the pit level
    ...
    peaks, _ = find_peaks(data, height = 65, distance = 180) # peaks are the indices of the peaks in the data, minimum height, distance between peaks, prominence and width can be adjusted
    # minimum height: 65%
    # minimum distance: 180 Indizes
    # 
